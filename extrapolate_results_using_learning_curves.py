...
projected_years = ['2040'] # for debugging !!!
...
for domain in domains:
    ...
    for year in projected_years:
        ...
        ## CapEx            
        # fixed 
        data_cost_reduction_applied.loc[data_cost_reduction_applied.depth < 60, 'capex_kw'] = data.loc[data.depth < 60, 'capex_kw'] * capex_cost_reduction_fixed
        # floating
        data_cost_reduction_applied.loc[data_cost_reduction_applied.depth > 60, 'capex_kw'] = data.loc[data.depth > 60, 'capex_kw'] * capex_cost_reduction_floating
            
        ## Opex
        # fixed
        data_cost_reduction_applied.loc[data_cost_reduction_applied.depth < 60, 'opex_kw'] = data.loc[data.depth < 60, 'opex_kw'] * opex_cost_reduction_fixed
        # floating
        data_cost_reduction_applied.loc[data_cost_reduction_applied.depth > 60, 'opex_kw'] = data.loc[data.depth > 60, 'opex_kw'] * opex_cost_reduction_floating
